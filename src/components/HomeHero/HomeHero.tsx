...
type HomeHeroProps = {
  // Принимаем функцию клика
  onCtaClick: () => void;
};

const HomeHero = ({ onCtaClick }: HomeHeroProps) => {
  return (
    <div className={style.hero}>
      <div className="container">
        <HomeHeroTitleBlock onCtaClick={onCtaClick} />
        <HeroCards />
      </div>
      <HomeHeroImageBlock />
      <img
        src="./image/home/hero-lines.png"
        alt="three green curves"
